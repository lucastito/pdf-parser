...
| | |
|---|---|
| Testes | **781 passando**, 10 saltados (`pytest -m "not experimento_a"`) — atualizado em 2026-08-12 após fechar P-1.1/P0.1 e cobrir `cli.py::_comparar`, branches de erro de `_avaliar`, e um teste de integração ponta a ponta contra um documento real do corpus. `pytest-randomly` ligado por padrão (ordem embaralhada a cada rodada) — ver −1.2 |
